...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Khimberly') }}</title>
    ...
    <body>
       ...
       <div class="w-screen h-screen bg-black flex items-center overflow-hidden">

            <div class="w-full relative bg-black bg-cover bg-no-repeat h-full">
              <!-- Gradient blobs -->
                ...
                <div class="w-[80%] mx-auto h-full flex justify-between items-center">
                  <div class="h-full xl:w-[50%] md:w-[60%] sm:w-[70%] w-full text-white flex flex-col gap-2 justify-center">
                        ...
                        <h1 class="xl:text-7xl lg:text-6xl md:text-5xl text-4xl font-semibold bg-text">Khimberly Khate Fontanilla!</h1>
                            <div class="h-auto xl:w-[50%] md:w-[60%] sm:w-[70%] w-full text-white flex flex-col gap-2 justify-center">
                              ...
                              <h2 id="typewriter" class="xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-xl font-bold"></h2>
                                ...
                                <script>
                                  const words = ["Web Developer", "Mobile Developer", "Graphic Designer", "Video Editor"];
                                  let i = 0;
                                  let j = 0;
                                  let currentWord = '';
                      ...
                      <div class="flex sm:flex-row flex-col gap-4 lg:mt-4 mt-2">
                            <button class="md:px-8 px-4 md:py-4 py-2 md:text-xl text-lg font-semibold rounded-md gradiant cursor-pointer">
                              <a href="#projects">My Projects</a>
                            </button>
                            <button class="md:px-8 px-4 md:py-4 py-2 md:text-xl text-lg font-semibold outline outline-2 rounded-md cursor">
                    ...
                    <div class="md:w-1/2 mt-12 md:mt-0 flex justify-center">
                        <img src="{{ asset('images/webicon.png') }}" alt="Web Icon" 
                            class="w-72 h-auto rounded-lg shadow-lg opacity-0 animate-fade-in" />
                    </div>
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      ...
      <div class="text-gray-700 space-y-6">
        ...
        <p class="text-lg leading-relaxed text-justify">
          I’m confident navigating both technical and business environments, with working knowledge of <span class="font-medium text-gray-900">SAP Business One ERP</span>. Whether I’m debugging code, designing interfaces, or collaborating with a team, I bring strong <span class="font-semibold text-blue-600">communication</span>, <span class="font-semibold text-blue-600">leadership</span>, and <span class="font-semibold text-blue-600">analytical thinking</span> to every project.
                ...
                <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                        ...
                        <img src  ="{{ asset('images/java.png') }}" alt="JAVA"  class="h-15 fill-current text-gray-600 hover:text-green-700" />
                        <img src  ="{{ asset('images/js.png') }}" alt="JAVASCRIPT"  class="h-15 fill-current text-gray-600 hover:text-green-700" />
                        <img src  ="{{ asset('images/php.png') }}" alt="PHP"  class="h-15 fill-current text-gray-600 hover:text-green-700" />
                        <img src  ="{{ asset('images/laravel.png') }}" alt="LARAVEL"  class="h-15 fill-current text-gray-600 hover:text-green-700" />
                        <img src  ="{{ asset('images/react.png') }}" alt="REACT"  class="h-15 fill-current text-gray-600 hover:text-green-700" />
                        <img src  ="{{ asset('images/sql.png') }}" alt="SQL"  class="h-15 fill-current text-gray-600 hover:text-green-700" />
                        <img src  ="{{ asset('images/postgre.png') }}" alt="POSTGRE"  class="h-15 fill-current text-gray-600 hover:text-green-700" />
                        <img src  ="{{ asset('images/androidstud.png') }}" alt="ANDROID STUD"  class="h-15 fill-current text-gray-600 hover:text-green-700" />
                </div>
            </div>
        </section>

        <!-- <Projects Section -->
        <section id="projects" class="py-20 px-4 sm:px-6 lg:px-8 bg-black text-white">
        ...
        <!--Contact Section-->
        <section id="contact" class="py-20 px-4 sm:px-6 lg:px-8 bg-white text-black">
      ...
      <div>
        ...
        <p class="text-xl text-black-300 mb-8">
          Have questions or ready to book? Reach out to us anytime.
        </p>
        <div class="space-y-6">
          <!-- Location -->
          <div class="flex items-start">
            <svg class="h-6 w-6 text-amber-600 mt-1 mr-4 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <div>
              ...
              <p class="text-black-300"> Marikina City, Philippines</p>
            </div>
          </div>

          <!-- Phone -->
          <div class="flex items-start">
            <svg class="h-6 w-6 text-amber-400 mt-1 mr-4 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
              viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div>
              ...
              <p class="text-black-300">+63 993 276 7058</p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            ...
            <div>
              ...
              <p class="text-black-300">fontanillakhimberly@gmail.com</p>
            </div>
          </div>
        </div>
        ...
        <div class="mt-8 flex space-x-4">
          <!-- Facebook -->
          <a href="#" class="w-10 h-10 rounded-full bg-black-800 flex items-center justify-center hover:bg-amber-500 transition-colors" aria-label="Facebook">
          ...
          <!-- Instagram -->
          <a href="#" class="w-10 h-10 rounded-full bg-black-800 flex items-center justify-center hover:bg-amber-500 transition-colors" aria-label="Instagram">
            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <!-- Twitter -->
          <a href="#" class="w-10 h-10 rounded-full bg-black-800 flex items-center justify-center hover:bg-amber-500 transition-colors" aria-label="Twitter">
            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <!-- LinkedIn -->
          <a href="#" class="w-10 h-10 rounded-full bg-black-800 flex items-center justify-center hover:bg-amber-500 transition-colors" aria-label="LinkedIn">
            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <!-- Contact Form -->
          <div class="bg-gray-800 p-8 rounded-xl">
            <h3 class="text-2xl text-white font-bold mb-6">Send Us a Message</h3>
            <form class="space-y-6">
              <div>
                <label for="name" class="block text-sm text-white font-medium mb-1">Your Name</label>
                <input type="text" id="name" class="w-full px-4 py-3 rounded-lg bg-gray-700 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-amber-500" placeholder="Enter your name" />
              </div>
              <div>
                <label for="email" class="block text-sm text-white font-medium mb-1">Email Address</label>
              ...
              <div>
                <label for="message" class="block text-sm text-white font-medium mb-1">Message</label>
